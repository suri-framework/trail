...
let hash = function
  | "sidewinder_web_runtime.mjs" | "/sidewinder_web_runtime.mjs" -> Some "0d1bcf6b391c5d83877be0883c39bd19"
  | _ -> None

let size = function
  | "sidewinder_web_runtime.mjs" | "/sidewinder_web_runtime.mjs" -> Some 1576
  | _ -> None
